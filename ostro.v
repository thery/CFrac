...
set S := \big[_/_]_(_ <  _) _.
have BS1 : 't[r]_2 <= Rabs S <= 1 - 't[r]_1.
  split.
    have /eqP F1 := o2_neq0.
    apply: Rle_trans (bound_left_big _ _ _ _ _ _ F1 _) => //; last 2 first.
  ...
  by apply: irrational_elt_neq_0.
apply: Rmod1_0L1 BS1; split; first by apply: halton_pos.

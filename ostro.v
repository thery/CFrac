...
(******************************************************************************)
(* This file contains some basic properties of Ostrowski numeration.          *)
(* It follows the material found in                                           *)
(*   Continued Fractions - Andrew M Rockett, Peter Szusz                      *)
(*                                                                            *)
(*  'z[r]_n    = the n^th complete quotient of r                              *)
(*                                                                            *)
(*  'bo[r,n]   = the bound of the summation of n in the Ostrovski numeration  *)
(*               of base r                                                    *)
(*  'o[r,n]_i  = the i^th element of the Ostrowski numeration of n in base r  *)
(*               of base r                                                    *)
(*  'mo[r,n] =   the index of the first non-zero element of the Ostrowski     *)
